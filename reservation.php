...
<body>
    ...
    <form method="POST" action="reservationprocess.php">
        ...
        <button type="button" class="exisbutton" onclick="location.href='oldcustomer.php?CarID=<?php echo $CarID ?>'">Existing Customer</button>
        </div><br><br>

    <div>
        <div class="reservation-container">
            <h2>New Customer Information</h2>
            <input name="CustomerID" type="hidden" value="0" readonly/>  
            <br>
            <div class="row">
            <label>First Name:</label>
            <input class = "info" name="firstname" placeholder="Example: Gary" required/>  
            </div><br>

            <div class="row">
            <label>Last Name:</label>
            <input class = "info" name="lastname" placeholder="Example: Chai" required/>  
            </div><br>

            <div class="row">
            <label>Telephone Number:</label>
            <input class = "info" name="telophonenum" maxlength=12 placeholder= "Example: 0124421421" required/>     
            </div><br>

            <div class="row">
            <label>Address:</label>
            <input class = "info" name="Address" maxlength=100 placeholder= "Example: 1, Jalan Semenyih" required/>     
            </div><br>

            <div class="row">
            <label>Email:</label>
            <input class = "info" name="Email" maxlength=50 placeholder= "Example: gary03@gmail.com" required/>     
            </div><br>
        </div>
        ...
        <div>
        <input class="buttonbottom button" type="submit" value="Submit">
        <button class="buttonbottom button" type="button" onclick="location.href='cars.php'">Back</button>
        </div>
